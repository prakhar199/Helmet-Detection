...
classesFile = r"C:\Users\Prakhar\Desktop\program\yolov3-Helmet-Detection\obj.names";
classes = None
with open(classesFile, 'rt') as f:
    classes = f.read().rstrip('\n').split('\n')

# Give the configuration and weight files for the model and load the network using them.
modelConfiguration = r"C:\Users\Prakhar\Desktop\program\yolov3-Helmet-Detection\yolov3-obj.cfg";
modelWeights = r"C:\Users\Prakhar\Desktop\program\yolov3-Helmet-Detection\yolov3-obj_2400.weights";
